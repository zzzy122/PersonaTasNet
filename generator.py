...
def mix(hp, args, audio, num, s1_dvec, s1_target, s2, train):
    ...
    # librosa.core.write_wav(target_wav_path, w1, srate)
    # librosa.core.write_wav(mixed_wav_path, mixed, srate)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-d', '--libri_dir', type=str, default=os.getcwd() + '/data_ziyun/train-clean-100/LibriSpeech',
    parser.add_argument('-d', '--libri_dir', type=str, default=os.getcwd() + '/data_ziyun/train-clean-100-1percent/LibriSpeech',
    ...
    parser.add_argument('-o', '--out_dir', type=str, default=os.getcwd() + '/data_baen/output_ziyun',
                        help="Directory of output training triplet")
    ...
    def train_wrapper(num):
        # 从训练集中随机选择两个不同说话人的音频文件夹
        spk1, spk2 = random.sample(train_spk, 2)
        
        # 从第一个说话人的文件夹中随机选择两个音频文件
        # s1_dvec用于生成说话人特征向量,s1_target是目标语音
        s1_dvec, s1_target = random.sample(spk1, 2)
        
        # 从第二个说话人的文件夹中随机选择一个音频文件作为干扰语音
